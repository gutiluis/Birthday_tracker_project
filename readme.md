...
- Loads data from birthdays.csv, and users are displayed a selections menu from the CLI
...
* **GitHub Discussions:** [Open a discussion](https://github.com/gutiluis/Birthday-tracker/discussions)
